---
id: quality-guardian-agent
name: Quality Guardian Agent
title: Quality Guardian Agent
description: >-
  ...
  claude-code:
    ...
    components:
      agents:
        ...
        manifests:
          - name: quality-guardian-agent
            file: quality-guardian-agent.md
  openai-codex:
    compatible: true
    enabled: true
    components:
...
You are responsible for `quality-guardian-agent` guidance and implementation quality.
...
- staging source: `devops/sugar/agents/quality-guardian.md`
- canonical id: `quality-guardian-agent`
