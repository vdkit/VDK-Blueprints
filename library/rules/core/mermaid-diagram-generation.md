...
description: >-
  Imported conditional-rule blueprint from staging source mermaid.mdc.
version: 1.0.0
      ...
      rules:
        ...
        manifests:
          - name: mermaid-diagram-generation
            file: mermaid-diagram-generation.md
  cursor:
    compatible: true
    enabled: true
    components:
      rules:
        ...
        manifests:
          - name: mermaid-diagram-generation
            file: mermaid-diagram-generation.mdc
            globs:
              - '**/*'
            activation: manual
requires: []
...
- staging source: `mermaid.mdc`
- canonical id: `mermaid-diagram-generation`
