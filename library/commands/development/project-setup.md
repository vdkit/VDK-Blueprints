...
description: >-
  Set up new projects with proper structure and best practices including
  templates, configuration, and development environment
target: claude-code
...
examples:
  ...
  - usage: /setup --type api --lang go
    ...
    expectedOutcome: >-
      Go API with project structure, database, testing, and deployment
      configuration
...
compatibilityNotes: >-
  Supports Web, API, CLI, and Full-stack project types with multiple language
  and framework options
schemaVersion: '3.0'
title: Project Setup Helper
kind: command
specificityLayer: L2
platforms:
  claude-code:
