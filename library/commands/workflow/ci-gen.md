...
description: >-
  Generate comprehensive CI/CD pipelines for GitHub Actions, GitLab CI, and
  CircleCI with security and deployment automation
target: claude-code
...
examples:
  - usage: /ci-gen --template advanced
    description: >-
      Generate comprehensive CI/CD pipeline with matrix testing, security
      scanning, and deployment
    context: Setting up production-ready CI/CD for new project
    expectedOutcome: 'Complete workflow with testing, security, building, and deployment stages'
  - usage: /ci-gen --platform gitlab --security
    description: >-
      Create GitLab CI pipeline with enhanced security scanning and compliance
      checks
    context: Migrating from GitHub Actions to GitLab CI with security focus
    expectedOutcome: >-
      GitLab CI configuration with SAST, dependency scanning, and vulnerability
      assessment
  - usage: /ci-gen --update
    description: >-
      Update existing CI configuration with latest best practices and security
      improvements
    context: Modernizing legacy CI pipeline with current standards
    expectedOutcome: >-
      Updated pipeline configuration with improved caching, security, and
      performance
installation:
  dependencies:
    - git
  setupSteps:
    ...
    - Configure CI platform access tokens if needed
category: workflow
tags:
  - ci-cd
  - github-actions
...
compatibilityNotes: 'Supports GitHub Actions, GitLab CI, CircleCI with multi-language detection'
schemaVersion: '3.0'
...
Generate comprehensive CI/CD pipelines for multiple platforms with technology stack detection, security integration, and deployment automation. Creates production-ready workflows following industry best practices.
