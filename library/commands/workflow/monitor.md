...
description: >-
  Comprehensive monitoring, observability, and alerting systems for
  applications, infrastructure, and business metrics
target: claude-code
...
**Service Mesh**: !`kubectl get pods -n istio-system 2>/dev/null || echo "No service mesh detected"`
