---
id: release
name: Release Automation Suite
description: >-
  Automates the entire software release process including version bumping,
...
examples:
  - usage: /release --type minor
    description: >-
      Create minor release with automatic version bumping and changelog
      generation
    context: Releasing new features with backwards compatibility
    expectedOutcome: >-
      Version updated, changelog generated, git tags created, GitHub release
      published
  - usage: /release --prerelease beta
    description: Create beta prerelease for testing before stable release
    context: Releasing beta version for user testing and feedback
    expectedOutcome: >-
      Beta version tagged, prerelease artifacts built, testing documentation
      provided
  - usage: /release --dry-run
    description: Preview release changes without executing the actual release process
    context: Validating release configuration and checking what would be released
    expectedOutcome: 'Release preview with version changes, changelog, and artifact list'
installation:
  dependencies:
    - git
    - gh
  ...
  setupSteps:
    - Configure release automation tools and credentials
    - Set up package registry access tokens
...
compatibilityNotes: >-
  Supports semantic versioning, conventional commits, and multi-platform
  distribution
schemaVersion: '3.0'
title: Release Automation Suite
kind: command
specificityLayer: L2
platforms:
  claude-code:
