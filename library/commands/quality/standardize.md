---
id: standardize
name: Code Standardization Suite
description: >-
  Apply consistent coding standards, naming conventions, and architectural
...
examples:
  - usage: /standardize --aspect naming
    description: >-
      Standardize naming conventions for files, variables, functions, and
      database elements
    context: Cleaning up inconsistent naming across legacy codebase
    expectedOutcome: >-
      Consistent naming following camelCase, PascalCase, and snake_case
      conventions with updated imports
  - usage: /standardize --aspect structure
    description: >-
      Reorganize project structure following standard conventions and best
      practices
    context: Refactoring project layout for better maintainability and team onboarding
    expectedOutcome: >-
      Standard directory structure with properly organized components, services,
      and utilities
  - usage: /standardize --aspect all
    description: >-
      Comprehensive standardization including naming, structure, patterns, and
      documentation
    context: Major codebase cleanup before team expansion or major feature development
    expectedOutcome: >-
      Fully standardized codebase with consistent patterns, error handling, and
      documentation
installation:
  dependencies:
    - formatters
    ...
    - code analysis tools
  setupSteps:
    - 'Install language-specific formatters (deno fmt, gofmt, cargo fmt)'
    - Configure linting rules and editor configuration
    - Set up pre-commit hooks for automatic standardization
category: command
tags:
  - standardization
  - code-style
...
compatibilityNotes: >-
  Supports TypeScript/JavaScript, Go, Rust with comprehensive naming and
  structure standardization
schemaVersion: '3.0'
title: Code Standardization Suite
kind: command
specificityLayer: L2
platforms:
  claude-code:
