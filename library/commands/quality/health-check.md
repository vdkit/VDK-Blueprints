...
description: >-
  Implement comprehensive health monitoring for services, databases, and
  infrastructure with automated alerting and status reporting
target: claude-code
commandType: custom-slash
version: 1.0.0
scope: project
claudeCode:
  slashCommand: /health-check
  arguments:
    supports: true
...
examples:
  - usage: /health-check --service api
    description: Set up health monitoring for API service with database and cache checks
    context: Adding health endpoints to production API service
    expectedOutcome: 'Health check endpoints, Kubernetes probes, and monitoring integration'
  - usage: /health-check --generate-dashboard
    description: Create comprehensive health status dashboard with real-time monitoring
    context: Building operations dashboard for service health visibility
    expectedOutcome: 'HTML status page, Prometheus metrics, and alerting rules'
  - usage: /health-check --setup-alerts
    description: Configure alerting for critical service health failures
    context: Setting up production monitoring and incident response
    expectedOutcome: 'Alert rules, notification channels, and escalation procedures'
installation:
  dependencies:
    - curl
    - monitoring tools
...
compatibilityNotes: >-
  Supports HTTP health endpoints, Kubernetes probes, Prometheus metrics, and
