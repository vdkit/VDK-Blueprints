...
description: >-
  Generates comprehensive user-facing documentation including README, API docs,
  and changelogs from codebase analysis
target: claude-code
...
examples:
  - usage: /document --all
    description: >-
      Generate complete documentation suite including README, API docs, and
      changelog
    context: Preparing project for public release or onboarding new contributors
    expectedOutcome: >-
      Comprehensive documentation with installation guides, API reference, and
  ...
  - usage: /document --api-docs
    ...
    expectedOutcome: >-
      Updated API documentation with endpoints, examples, and authentication
      guides
  - usage: /document --readme-only
    ...
    expectedOutcome: >-
      Updated README with current tech stack, installation, and usage
      instructions
installation:
  dependencies:
    - git
