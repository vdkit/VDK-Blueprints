---
id: python-configuration-management
      ...
      skills:
        ...
        manifests:
          - name: python-configuration-management
            file: python-configuration-management.md
  github-copilot:
    compatible: true
    enabled: true
    components:
...
- staging source: `python-development/skills/python-configuration/SKILL.md`
- canonical id: `python-configuration-management`
